...
$_SESSION['ch_contact'] = "";
$_SESSION['ch_email'] = "";
$_SESSION['ch_soc_acct'] = "";
if($_SESSION['home_settings']=="0")
  {
    $_SESSION['ch_dtc_id'] = $_GET['chDtcID'];
    $_SESSION['ch_dtc_name'] = $_GET['chDtcName'];
  }else
  {
    $_SESSION['ch_dtc_id'] = "0";
    $_SESSION['ch_dtc_name'] = "";
  }

$_SESSION['ch_year_est'] = "";
$_SESSION['ch_church_his'] = "";
$_SESSION['ch_property'] = "";
$_SESSION['ch_property_info'] = "";
$_SESSION['ch_pStatus'] = "Rented";
$_SESSION['ch_other_info'] = "";
$_SESSION['ch_notes'] = "";
$_SESSION['ch_min_id'] = "0";
$_SESSION['ch_min_name'] = "N/A";
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <i class="fa fa-home"> <b>Churches</b></i>
        <br><br>
        <!--Select District-->
        <form method="post">
          <?php
          ...
          ?>
                        ...
                        $fgmembersite->DBlogin();
                                ...
                                $result = mysqli_query($fgmembersite->connection, $query);
                                 ...
                                 if($_SESSION['menuPage'] == '1')
                                  {
                                    echo "<option value=". $_SESSION["dtcLabelID"] ." selected>". $_SESSION["dtcLabel"] ."</option>";
                                  }
                ...
                <a class='btn btn-primary, pull-right' href='ch_add.php?chDivID=". $_SESSION['divLabelID'] ."&chDtcID=". $_SESSION['dtcLabelID'] ."&chDtcName=". $_SESSION['dtcLabel'] ."&chDivName=". $_SESSION['divLabel'] ."'><b>Add Church</b></a>
          </div>
          <div class='card-body'>
          <div class='table-responsive'>
              ...
              ";
                  ...
                  if ($result->num_rows > 0)
                    ...
                    while ($row = $result->fetch_assoc())
                     ...
                     if ($minresult->num_rows > 0)
                      ...
                      echo '<td align="center"><a href="ch_mem_menu.php?churchID='. $row["ch_id"] .'&churchName='. $row["ch_name"] .'&chDivID='. $row["ch_div_id"] .'&chDtcID='. $row["ch_dtc_id"] .'&chDivName='. $chDivName .'&chDtcName='. $chDtcName .'"><i class="fa fa-users" /></a></td>';
                      //summary
                      echo "<td align=center>
                      <a href='ch_summary.php?churchID=". $row["ch_id"] ."' onclick='basicPopup(this.href);return false' class='fa fa-list'></a>
                      </td>";
                      if ($_SESSION['edit_church'] == "1")
                      {
                      echo '<td align="center"><A HREF="ch_edit.php?churchID='. $row["ch_id"] .'&churchName='. $row["ch_name"] .'&chDivID='. $row["ch_div_id"] .'&chDtcID='. $row["ch_dtc_id"] .'&chDivName='. $chDivName .'&chDtcName='. $chDtcName .'"><i class="fa fa-pencil" /></A></td>';
                      }
                      if ($_SESSION['delete_church'] == "1")
                      {
                      echo '<td align="center"><A HREF="ch_delete.php?churchID='. $row["ch_id"] .'&churchName='. $row["ch_name"] .'&chDivID='. $row["ch_div_id"] .'&chDtcID='. $row["ch_dtc_id"] .'&chDivName='. $chDivName .'&chDtcName='. $chDtcName .'" onclick="return confirm(\'The church will be deleted when you click OK\')"><i class="fa fa-trash" /></A></td>';
                      echo "</tr>";
                      }
                      }
                    }
                ...
                <a class='btn btn-primary, pull-right' href='ch_add.php?chDivID=". $_GET['chDivID'] ."&chDtcID=". $_GET['chDtcID'] ."&chDtcName=". $_GET['chDtcName'] ."&chDivName=". $_GET['chDivName'] ."' ><b>Add Church</b></a>
          </div>
          <div class='card-body'>
          <div class='table-responsive'>
                  ...
                  if ($result->num_rows > 0)
                    ...
                    while ($row = $result->fetch_assoc())
                     ...
                     if ($minresult->num_rows > 0)
                      ...
                      echo "<td>" . $min_name . "</td>";
                      echo "<td>" . $row["ch_status"] . "</td>";
                      echo '<td align="center"><a href="ch_mem_menu.php?churchID='. $row["ch_id"] .'&churchName='. $row["ch_name"] .'&chDivID='. $row["ch_div_id"] .'&chDtcID='. $row["ch_dtc_id"] .'&chDivName='. $_GET['chDivName'] .'&chDtcName='. $_GET['chDtcName'] .'"><i class="fa fa-users" /></a></td>';
                      //summary
                      echo "<td align=center>
                      <a href='ch_summary.php?churchID=". $row["ch_id"] ."' onclick='basicPopup(this.href);return false' class='fa fa-list'></a>
                      </td>";
                       if ($_SESSION['edit_church'] == "1")
                      {
                      echo '<td align="center"><A HREF="ch_edit.php?churchID='. $row["ch_id"] .'&churchName='. $row["ch_name"] .'&chDivID='. $row["ch_div_id"] .'&chDtcID='. $row["ch_dtc_id"] .'&chDivName='. $_GET['chDivName'] .'&chDtcName='. $_GET['chDtcName'] .'"><i class="fa fa-pencil" /></A></td>';
                      }
                       if ($_SESSION['delete_church'] == "1")
                      {
                      echo '<td align="center"><A HREF="ch_delete.php?churchID='. $row["ch_id"] .'&churchName='. $row["ch_name"] .'&chDivID='. $row["ch_div_id"] .'&chDtcID='. $row["ch_dtc_id"] .'&chDivName='. $_GET['chDivName'] .'&chDtcName='. $_GET['chDtcName'] .'"><i class="fa fa-trash" /></A></td>';
                      }
                      echo "</tr>";
