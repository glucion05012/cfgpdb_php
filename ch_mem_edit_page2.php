...
//church member children
    ...
    echo 'location.href="ch_mem_edit_page3.php?churchID='. $_POST['churchID'] .'&churchName='. $_POST['churchName'] .'&memID='. $_POST['memID'] .'&chDivName='. $_SESSION['chDivName'] .'&chDtcName='. $_SESSION['chDtcName'] .'&chDivID='. $_SESSION['chDivID'] .'&chDtcID='. $_SESSION['chDtcID'] .'"';
    echo '</script>';
}
else if(isset($_POST['back']))
{
	...
	echo '<script language="javascript">';
    echo 'location.href="ch_mem_edit.php?churchID='. $_POST['churchID'] .'&churchName='. $_POST['churchName'] .'&memID='. $_POST['memID'] .'&chDivName='. $_SESSION['chDivName'] .'&chDtcName='. $_SESSION['chDtcName'] .'&chDivID='. $_SESSION['chDivID'] .'&chDtcID='. $_SESSION['chDtcID'] .'"';
    echo '</script>';
}
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="ch_menu.php?chDivID=0&chDtcID=0&chDtcName=-&chDivName=-">Churches</a>
        </li>
        <li class="breadcrumb-item">
				...
				<form action='<?php echo $fgmembersite->GetSelfScript(); ?>' method='post'>
					...
					<table id="ch_mem_cdn_data_table" frame="box">
						...
						<div>
							...
							if($_SESSION['back']=="0")
							{
								$query = "SELECT * FROM tbl_ch_mem_children where cdn_mem_id = $_GET[memID]";
							}
					...
					<table id="ch_mem_educ_data_table" frame="box">
						...
						<div>
							...
							if($_SESSION['back']=="0")
							{
								$query = "SELECT * FROM tbl_ch_mem_education where educ_mem_id = $_GET[memID]";
							}
							elseif($_SESSION['back']=="1")
							{
					...
					<table id="ch_mem_train_data_table" frame="box">
						...
						<div>
							...
							if($_SESSION['back']=="0")
							{
								$query = "SELECT * FROM tbl_ch_mem_training where trn_mem_id = $_GET[memID]";
							}
							elseif($_SESSION['back']=="1")
							{
