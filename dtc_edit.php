	...
	if($fgmembersite->UpdateDistrict())
		{
			...
			echo 'alert("District successfully updated!"); location.href="dtc_menu.php"';
			echo '</script>';
		}	
}
				...
				<form  action='". $fgmembersite->GetSelfScript() ."' method='post'>
					<table>
						...
						<tr>
							...
							<td><textarea class='form-control' type='text' style='width:210px; height:50px' name='dtc_spvr' maxlength='1000' />". $spvr ."</textarea></td>
							</div>
						</tr>
					</table>
					<br><br>
